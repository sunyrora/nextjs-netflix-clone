...
const MoreInfo = ({ video, show = true }) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full h-[50vh] max-h-[350px] netflix-md:max-h-[720px] min-h-[350px] netflix-md:min-h-[480px]
        z-[60]
        "
      >
        {/* gradient */}
        <div className="absolute z-[56] inset-0 w-full h-[120%] bg-gradient-to-b from-white/0 to-bggray-100/100"></div>
              ...
              >
                <div className="flex space-x-1.5 x-fit transition-all moreinfo-play-button-container">
                  ...
                  <div className="moreinfo-button-outline-container ">
                    <button onClick={() => refPlayer?.current.play()}>
                      <svg
                        width={24}
                        height={24}
                        fill="none"
                  ...
                  {/* Thumb up button */}
                  <div className="moreinfo-button-outline-container ">
                    <button onClick={() => refPlayer?.current.stop()}>
                      <svg
                        width={24}
                        height={24}
                        fill="none"
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-between grow-[3]">
                      ...
                      <div className="gorw-[1]">{Math.round(duration)}min</div>
                    </div>
